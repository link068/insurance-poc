	...
	<div class="modal fade" id="assignModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <p style="color:black;"><b>Application Id</b><span class="form-control" style="width: 60%;">{{assignAppDetails.applicationId}}</span></p>
          <p style="color:black;"><b>Application Name</b><span class="form-control" style="width: 60%;">{{assignAppDetails.name}}</span></p>
          <p style="color:black;"><b>Email</b><span class="form-control" style="width: 60%;">{{assignAppDetails.email}}</span></p>
          <p style="color:black;"><b>Policy</b><span class="form-control" style="width: 60%;">{{assignAppDetails.policy}}</span></p>
        </div>
