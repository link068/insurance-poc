<div class="row">
            ...
            <tr class="gradeA" ng-repeat="application in assignedApplications">
            	...
            	<td>
            		<!-- Button trigger modal -->
			          <button class="btn btn-primary" data-toggle="modal" data-target="#assignModal2" ng-click="assignApp($index, application);">
			          	<i class="fa fa-hand-o-left"></i> Re-assign
			          </button>
  ...
  <!-- Modal -->
	...
	<!-- Modal -->
	<div class="modal fade" id="assignModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
