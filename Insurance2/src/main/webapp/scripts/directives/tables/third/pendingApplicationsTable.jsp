              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="example">
                ...
                <tbody>
                  <tr class="gradeA" ng-repeat="application in applications | filter: {status: 'Working'}">
                  	...
                  	<td><button data-toggle="modal" data-target="#myModal5" ng-click="viewDetails(application);"><img src="http://localhost:8080/insurance-bank/webapi/photo?id={{application.applicationId}}" height="50px"></button></td>
                  	<td>
