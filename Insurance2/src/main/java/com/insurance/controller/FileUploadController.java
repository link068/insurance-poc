...
import com.insurance.model.FileModel;
...
public class FileUploadController {
   ...
   public ModelAndView fileUploadPage(@RequestParam("id") int id, Model model) {
   ...
   public String fileUpload(@Validated FileModel file, BindingResult result, Model model) throws IOException {
